...
class Pemasukan_kas_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('pemasukan_kas_m','model');
	...
	{
		$get_nomor					= $this->master_model_m->get_nomor_dokumen('BKM');
		...
		if($this->input->post('save')){
		    ...
		    $this->db->insert('tb_bukti_kas_masuk',$data);
		    ...
		    $this->master_model_m->update_nomor("BKM");
    		...
    		$this->db->update('tb_bukti_kas_masuk', $data);
		...
		$data = array(
				...
				'page'  	 		=> 'pemasukan_kas_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Bukti Kas Masuk',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'bukti_kas_masuk',
				'lihat_data' 		=> $this->model->lihat_data(),
				'url_simpan' 		=> base_url().'pemasukan_kas_c',
				'url_hapus'  		=> base_url().'pemasukan_kas_c/hapus',
				'url_ubah'	 		=> base_url().'pemasukan_kas_c',
				'get_nomor'	 		=> $get_nomor,
			);
	...
	function add_new(){
		$userinfo					= $this->master_model_m->get_user_info();
		$get_nomor					= $this->master_model_m->get_nomor_dokumen('BKM')."/BKM/".$userinfo->nama_divisi."/".$this->tgl_to_romawi(date('m'))."/".date('Y');
		$data = array(
				'title' 	 		=> 'Tambah Bukti Kas Masuk ',
				'page'  	 		=> 'add_pemasukan_kas_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Bukti Kas Masuk',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'bukti_kas_masuk',
	...
	function edit($id){
		...
		$data = array(
				'title' 	 		=> 'Ubah Bukti Kas Masuk (BKM)',
				'page'  	 		=> 'edit_pemasukan_kas_v',
				'sub_menu' 	 		=> 'Flow Sistem',
				'sub_menu1'	 		=> 'Bukti Kas Masuk',
				'menu' 	   	 		=> 'flow_sistem',
				'menu2'		 		=> 'bukti_kas_masuk',
	...
	function hapus()
	{
		...
		$this->db->where('ID', $id);
   		$this->db->delete('tb_bukti_kas_masuk'); 

		$this->session->set_flashdata('hapus','1');
		redirect('pemasukan_kas_c');
	}
