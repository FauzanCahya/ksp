...
class Po_non_produksi_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('po_non_produksi_m','permintaan');
	...
	public function index()
	{
		$data = array(
				...
				'url_simpan' 	  => base_url().'po_non_produksi_c/simpan',
				'url_hapus'  	  => base_url().'po_non_produksi_c/hapus',
			);
