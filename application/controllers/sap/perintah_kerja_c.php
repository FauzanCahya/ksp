...
class Perintah_kerja_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('sap/perintah_kerja_m','permintaan');
	...
	public function index()
	{
		$data = array(
				...
				'page'  	      => 'sap/perintah_kerja_v',
				'sub_menu' 	      => 'SAP',
				'menu' 	   	      => 'SAP',
				'lihat_data'      => $this->permintaan->lihat_data_permintaan(),
				'lihat_barang'    => $this->permintaan->lihat_data_barang(),
				'url_simpan' 	  => base_url().'perintah_kerja_c/simpan',
				'url_hapus'  	  => base_url().'perintah_kerja_c/hapus',
			);
