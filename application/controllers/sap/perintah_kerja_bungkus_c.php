...
class Perintah_kerja_bungkus_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('sap/perintah_kerja_bungkus_m','permintaan');
	...
	public function index()
	{
		$data = array(
				...
				'page'  	      => 'sap/perintah_kerja_bungkus_v',
				'sub_menu' 	      => 'SAP',
				'menu' 	   	      => 'SAP',
				'lihat_data'      => $this->permintaan->lihat_data_permintaan(),
				'lihat_barang'    => $this->permintaan->lihat_data_barang(),
				'url_simpan' 	  => base_url().'sap/perintah_kerja_bungkus_c/simpan',
				'url_hapus'  	  => base_url().'sap/perintah_kerja_bungkus_c/hapus',
			);
	...
	function simpan()
	{
		...
		if ($id_permintaan == '') {
			...
			$get_nomor	   		= $this->master_model_m->get_nomor_dokumen('perintah_kerja');
			...
			$this->master_model_m->update_nomor('perintah_kerja');
