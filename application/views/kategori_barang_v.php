...
<div class="row" style="display: none;" id="data_input">
    <div class="col-md-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Form Input Kategori Barang</h3>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form action="<?php echo $url_simpan; ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputpwd1">Nama Kategori</label>
                            <div class="input-group">
                                <div class="input-group-addon"><i class="ti-bookmark-alt"></i></div>
...
<button class="btn btn-success waves-effect waves-light" type="button" id="tombol_tambah" onclick="tambah_data();" id="tombol_tambah"><span class="btn-label"><i class="fa fa-plus-square"></i></span>Tambah Data Kategori Barang</button>
</br>
</br>
...
<div class="row" id="tabel_data">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-info">
            <div class="panel-heading">Tabel Data Kategori Barang</div>
						...
						<table id="myTable" class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align:center; vertical-align:"><?php echo $value->kode_kategori; ?></td>
