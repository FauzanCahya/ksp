	            ...
	            <div class="panel-wrapper collapse in">
	                <div class="panel-body">
	                	...
	                	<div class="row" style="margin-bottom: 10px;">
	                		<div class="col-md-12">
	                			<div class="col-md-2">
									<label class="control-label"><b style="font-size:14px;">NO REG</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jenis" id="jenis" value="" required style="text-align: center;height: 100px;font-size: 60px;">
									</div>
								</div>
	                		</div>
	                	</div>
	                	...
	                	<div class="row" >
							<div class="col-md-12">
								...
								<div class="col-md-4" >
									<label class="control-label"><b style="font-size:14px;">Mesin</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="kode" id="kode" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-legal"></i></button></span>
									</div>
								</div>
								<div class="col-md-4">
									<label class="control-label"><b style="font-size:14px;">Bahan Baku</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="bahan_baku_awal" id="bahan_baku_awal" onkeyup="hasil_bahan_baku(this.value);" value="0" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-flask"></i></button></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-4">
									...
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="uk_1" id="uk_1" value="" onkeyup="ubah_uk_1(this.value);" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">x</button></span>
										<input type="text" class="form-control" name="uk_2" id="uk_2" value="" onkeyup="ubah_uk_2(this.value);" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">x</button></span>
										<input type="text" class="form-control" name="uk_3" id="uk_3" value="" onkeyup="ubah_uk_3(this.value);" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">x</button></span>
										<input type="text" class="form-control" name="uk_4" id="uk_4" value="" onkeyup="ubah_uk_4(this.value);" required style="text-align: center;font-size: 23px;">
									</div>
								</div>
								<div class="col-md-4" >
									<label class="control-label"><b style="font-size:14px;">Kode</b></label>
									<div class="input-group" style="width: 100%; ">
								...
								<div class="col-md-2">
									<label class="control-label"><b style="font-size:14px;">Bs yg di izinkan</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="bs" id="bs" value="0" required onkeyup="bs_fc(this.value);">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-calendar"></i></button></span>
									</div>
								</div>
								<div class="col-md-2">
									<label class="control-label"><b style="font-size:14px;">Susut</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="susut" id="susut" value="0" required onkeyup="bs_fc(this.value);">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-calendar"></i></button></span>
									</div>
								</div>
							</div>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-4">
									<label class="control-label"><b style="font-size:14px;">No Roll</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="roll_b" id="roll_b" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">-</button></span>
										<input type="text" class="form-control" name="roll_a" id="roll_a" value="" required style="text-align: center;font-size: 23px;" onkeyup="hasil(this.value);">
										
									</div>
								</div>
								<div class="col-md-4" >
									<label class="control-label"><b style="font-size:14px;">Berat/Roll</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="jenis" id="jenis" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">-</button></span>
										<input type="text" class="form-control" name="jenis" id="jenis" value="" required style="text-align: center;font-size: 23px;">
								...
								<div class="col-md-4">
									<label class="control-label"><b style="font-size:14px;">Hasil Roll</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="hasil_bahan" id="hasil_bahan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">Kg</button></span>
										<input type="text" class="form-control" name="hasil_roll" id="hasil_roll" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button">Roll</button></span>
									</div>
								</div>
							</div>
						</div>
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<td style="width: 26.6%;font-weight: bold;text-align: center;">Bruto</td>
											<td style="width: 26.6%;font-weight: bold;text-align: center;">Bobin</td>
											<td style="width: 26.6%;font-weight: bold;text-align: center;">Netto</td>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-2">
									<label class="control-label"><b style="font-size:14px;">Jam Jalan</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
								...
								<div class="col-md-2" >
									<label class="control-label"><b style="font-size:14px;">Jam Berhenti</b></label>
									<div class="input-group" style="width: 100%; ">
										<input type="text" class="form-control" name="jenis" id="jenis" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-clock-o"></i></button></span>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-4">
									<label class="control-label"><b style="font-size:14px;">Real M/menit</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-clock-o"></i></button></span>
									</div>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Operator</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
								</div>
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Bs Prod</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
								...
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Bs Stell/Cucian</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
								...
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Bs Gramatur</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
						...
						<div class="row" style="padding-top: 10px;">
							<div class="col-md-12">
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Ambil Bahan</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
								...
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Ambil bhn Cucian/stell</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
								...
								<div class="col-md-3">
									<label class="control-label"><b style="font-size:14px;">Sisa bahan di Oven</b></label>
									<div class="input-group" style="width: 100%;">
										<input type="text" class="form-control" name="jam_jalan" id="jam_jalan" value="" required style="text-align: center;font-size: 23px;">
										<span class="input-group-btn"><button class="btn default" type="button"><i class="fa fa-certificate"></i></button></span>
									</div>
...
<button class="btn btn-success waves-effect waves-light" type="button" id="tombol_tambah" onclick="tambah_data_a();" id="tombol_tambah"><span class="btn-label"><i class="fa fa-plus-square"></i></span>Tambah Data PK Roll</button>
</br>
</br>
