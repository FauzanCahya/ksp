...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12 col-xs-12">
        <div class="white-box">
            ...
            <div class="steamline">
                <div class="sl-item">
                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url()?>sales/plugins/images/users/genu.jpg"> </div>
                    <div class="sl-right">
                ...
                <div class="sl-item">
                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url()?>sales/plugins/images/users/ritesh.jpg"> </div>
                    <div class="sl-right">
                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
                ...
                <div class="sl-item">
                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url()?>sales/plugins/images/users/sonu.jpg"> </div>
                    <div class="sl-right">
                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
                ...
                <div class="sl-item">
                    <div class="sl-left"> <img class="img-circle" alt="user" src="<?php echo base_url()?>sales/plugins/images/users/govinda.jpg"> </div>
                    <div class="sl-right">
                        <div><a href="#">Gohn Doe</a> <span class="sl-date">5 minutes ago</span></div>
