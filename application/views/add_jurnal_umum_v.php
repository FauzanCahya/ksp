...
<div class="row" id="data_input">
    <div class="col-md-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Form Input Jurnal Umum</h3>
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-5">
								...
								<input type="hidden" class="form-control" id="total_all" name="total_all" value="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
							    <input class="form-control form-control-inline input-medium date-picker" type="text" value="<?=date('d-m-Y');?>" name="tgl" readonly style="background: #FFF; cursor: pointer;"/>
							</div>
						</div>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<a href="<?=base_url();?>jurnal_umum_c" id="batal" class="btn btn-danger">Batal Dan Kembali</a>
...
<input type="hidden" class="btn blue" value="2" name="total_row" id="total_row">
