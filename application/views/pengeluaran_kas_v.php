...
<a href="<?php echo base_url();?>pengeluaran_kas_c/add_new">
<button class="btn btn-success waves-effect waves-light" type="button" id="tombol_tambah" id="tombol_tambah"><span class="btn-label"><i class="fa fa-plus-square"></i></span>Input Kas Keluar</button>
</a>
</br>
</br>
        ...
        <div class="panel panel-info">
            <div class="panel-heading">Tabel Data Kode Akun</div>
				...
				<tr>
					...
					<td style="text-align:left; vertical-align:"><?php echo $value->nama_supplier; ?></td>
