...
<div class="row" id="data_input">
    <div class="col-md-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Form Kas Kecil</h3>
                    ...
                    <form action="<?php echo $url_simpan; ?>" method="post">
						<div class="form-body">
							<div class="form-group">
								<label class="control-label" for="form_control_1">No. Dokumen</label>
							...
							<div class="form-group">
								<label class="control-label" for="form_control_1">Tanggal</label>
								
								    <input class="form-control form-control-inline input-medium" type="text" value="<?=date('d-m-Y');?>" name="tgl" readonly >
								
							</div>

							<div class="form-group">
								<label class="control-label" for="form_control_1">Terima Dari</label>
								
									<select  class="form-control select2" id="id_pelanggan" name="id_pelanggan" data-placeholder="Select..." required>
										<option value=""></option>
										<?php 
							...
							<div class="form-group">
								<label class="control-label" for="form_control_1">Nilai</label>
								
									<input type="text" class="form-control text-right" id="nilai" name="nilai" required onkeyup="getTerbilang(this.value);">
								
							</div>

							<div class="form-group">
								<label class="control-label" for="form_control_1">Terbilang</label>
							...
							<div class="form-group">
								<label class="control-label" for="form_control_1" >Penerimaan Untuk</label>
						...
						<div class="table-scrollable">
	                        <table class="table table-bordered table-hover">
	                            ...
	                            <tbody id="dataAkun">
	                                <tr id="tr_1">
	                                    <td>
	                                    	<select  class="form-control select2" name="kode_akun[]" id="kode_akun_1" data-placeholder="Pilih Kode Perkiraan..." required>
													<option value=""></option>
													<?php 
	                                ...
	                                <tr id="tr_2">
	                                    <td>
	                                    	<select  class="form-control select2" name="kode_akun[]" id="kode_akun_2" data-placeholder="Pilih Kode Perkiraan..." required>
													<option value=""></option>
													<?php 
														foreach ($lihat_data_akun as $value){
													?>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-2 col-md-10">
									<a href="<?=base_url();?>pemasukan_kas_c" id="batal" class="btn btn-danger">Batal Dan Kembali</a>
