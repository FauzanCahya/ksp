...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Kas Keluar</div>
                ...
                <div class="panel-body">
					<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
						<div class="form-body">
							...
							<div class="form-group">
								<label class="col-md-2 control-label" for="form_control_1">Dibayar Kepada</label>
								<div class="col-md-5">
									<select  class="form-control select2" id="id_supplier" name="id_supplier" data-placeholder="Select..." required>
										<option value=""></option>
										<?php 
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-2 col-md-10">
									<a href="<?=base_url();?>pengeluaran_kas_c" id="batal" class="btn btn-danger">Batal Dan Kembali</a>
