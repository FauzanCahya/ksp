					...
					'<td align="center" style="vertical-align:middle;">'+
						'<div class="span12">'+
							'<div class="control-group">'+
								'<div classs="controls">'+
									'<div class="input-append" style="width: 100%;">'+
										'<input readonly value="'+res.nama_produk+'" type="text" id="nama_produk_'+i+'" class="form-control"  name="nama_produk[]" required style="background:#FFF; width: 90%; font-size: 13px; float: left;">'+
					...
					'<td align="center" style="vertical-align:middle;">'+
						'<div class="span12">'+
							'<div class="control-group">'+
								'<div class="controls">'+
									'<div class="input-append" style="width: 100%;">'+
										'<input readonly type="text" id="nama_produk_'+i+'" class="form-control"  name="nama_produk[]" required style="background:#FFF; width: 90%; font-size: 13px; float: left;">'+
										'<button onclick="show_pop_produk('+i+');" type="button" class="btn" style="width: 30%;">Cari</button>'+
					...
					'<td align="center" style="vertical-align:middle;">'+
						'<div class="span12">'+
							'<div class="control-group">'+
								'<div class="controls">'+
									'<div class="input-append" style="width: 100%;">'+
										'<input readonly type="text" id="nama_produk_'+i+'" class="form-control"  name="nama_produk[]" required style="background:#FFF; width: 90%; font-size: 13px; float: left;" value="'+nama_produk+'">'+
...
<div class="row" id="form_permintaan_barang" style="display: none;">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-info">
            <div class="panel-heading">Tabel Sales Order</div>
	            <div class="panel-wrapper collapse in">
	                <div class="panel-body">	
						...
						<div class="row" style="padding-top: 15px; padding-bottom: 15px;">
							<div class="portlet-body flip-scroll col-md-12 col-lg-12">
			...
			<div class="row" style="padding-top: 35px; padding-bottom: 15px;">
				<div class="col-md-12">
					<div class="col-md-offset-2 col-md-10">
						...
						<button type="button" id="batal" class="btn btn-danger" onclick="window.location = '<?php echo base_url(); ?>order_pembelian_c'">Batal Dan Kembali</button>
					</div>
				</div>
			</div>
        </div>
...
<button class="btn btn-success waves-effect waves-light" type="button" id="tombol_tambah" onclick="tambah_data_a();" id="tombol_tambah"><span class="btn-label"><i class="fa fa-plus-square"></i></span>Tambah Data Sales Order</button>
</br>
</br>
        ...
        <div class="panel panel-info">
            <div class="panel-heading">Tabel Sales Order</div>
				...
				<tr>
					...
					<th style="text-align:center;width: 15%"> No OPB</th>
					<th style="text-align:center;width: 50%"> Uraian</th>
				...
				<tr>
					<?php  } ?>
					<td style="text-align:center; vertical-align:width: 5%"><?php echo $no; ?></td>
					<td style="text-align:center; vertical-align:width: 15%"><?php echo $value->no_opb; ?></td>
					<td style="text-align:center; vertical-align:width: 50%"><?php echo $value->uraian; ?></td>
